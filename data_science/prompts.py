...
def return_instructions_root() -> str:
    ...
    - If the user wants to understand opinions or reviews from text, use the sentiment agent.
    ...
    <TASK>
        ...
        # 4b. **Sentiment Analysis TOOL (`call_sentiment_agent` - if applicable):** If the user's query involves understanding opinions, reviews, or satisfaction from text, use this tool. It takes a list of text comments and returns a sentiment score for each.
        ...
        #   * **Sentiment Analysis:** If the query is about analyzing user feedback or reviews, first use `call_db_agent` to get the text data, then pass the list of comments to `call_sentiment_agent`.
